...
import { getBalanceSheetStatementApi, getCashFlowStatementApi, getHistoricalChartApi, getHistoricalDailyChartApi, getIncomeStatementApi, getKeyMetricsApi } from 'redux/fundamentals/stockApi'
...
export default function StocksPage() {
  ...
  useEffect(() => {
    ...
    if (stockId !== '[stockId]') {
      ...
      dispatch(getIncomeStatementApi({ period: "manual", ticker: stockId }));
      dispatch(getBalanceSheetStatementApi({ period: "manual", ticker: stockId }));
      dispatch(getCashFlowStatementApi({ period: "manual", ticker: stockId }));
