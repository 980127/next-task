...
export default function Liner({ typeData }) {
  const [period, setPeriod] = React.useState('manual');
      ...
      <Stack direction="row" spacing={1} sx={{}}>
        ...
        <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }}>
          ...
          >
            ...
            <MenuItem sx={{ fontSize: '12px', lineHeight: '18px', fontWeight: 500, color: '#302F42' }} value={"manual"}>Manual</MenuItem>
            <MenuItem sx={{ fontSize: '12px', lineHeight: '18px', fontWeight: 500, color: '#302F42' }} value={"quarter"}>Quarter</MenuItem>
          </Select>
        </FormControl>
      </Stack>
