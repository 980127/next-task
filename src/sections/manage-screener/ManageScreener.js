      ...
      <Page title="Screener List | FindScan">
        <Container maxWidth="lg">
          ...
          <CustomTable
            ...
            getTableRow={(row) => {
              const { _id, description, isPrivate, scanCategory, screenerName, createdAt } = row;
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="left">
                    <NextLink href={`${PATH_SCREENER.root}/${_id}`} passHref>
                      <Button>{screenerName} </Button>
                    </NextLink>
                  </TableCell>
                  <TableCell align="left">
                    {description && <div style={{ height: '50px', overflow: 'scroll' }} dangerouslySetInnerHTML={{ __html: description }} />}
                  </TableCell>
